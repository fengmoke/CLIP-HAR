...
sys.path.append('D:\Study\Postgraduate\Deep_learning\paper\CLIP\Code\TS2ACT-main\dataset')
# from tip_adapter import *
from metaadapter import *
...
def PAMAP_TS2ACT_aug(clip_len = 500 ,dataset_dir='TS2ACT-main/dataset/data/PAMAP2',name="1-shot"):
...
# def get_tip_adapter_feature(clip_model= 'RN101'):
#     device = "cuda:0" if torch.cuda.is_available() else "cpu"
#     prompt = 'an action of'
#     labels = ['laying','sitting','standing','walking','running','cycling','Nordic walking','ascending stairs','descending stairs','vacuum cleaning','ironing','rope jumping',]
#     prompt_labels = [  prompt + 'laying',
...
#     cache_keys, cache_values = build_cache_model(10, model, train_dataloader, False)
#     train_features, train_labels = pre_load_features(model, train_dataloader, False)
#     run_tip_adapter(cache_keys, cache_values, train_features, train_labels, clip_weights)
