...
def UCI_TS2ACT_aug(shot = 10 ,dataset_dir='TS2ACT-main/dataset/data/UCI',name="10-shot",clip_len = 500):
...
def test(N):
    ...
    model, _, preprocess = open_clip.create_model_and_transforms(clip_model, pretrained='datacompdr') 
